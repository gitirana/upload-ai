      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <section className="grid grid-rows-2 gap-4 flex-1">
            ...
            <Textarea className="resize-none p-4 leading-relaxed" readOnly placeholder="Resultado gerado pela a IA..." />
          </section>
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <section className="space-y-2">
              ...
              <Textarea id="transcription_prompt" className="resize-y h-20 leading-relaxed" placeholder="Inclua palavras-chave mencionadas no vídeo separadas por vírgula" />
            </section>
